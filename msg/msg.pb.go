...
type SearchMessageReq struct {
	state         protoimpl.MessageState   `protogen:"open.v1"`
	SendID        string                   `protobuf:"bytes,1,opt,name=sendID,proto3" json:"sendID,omitempty"` // sender ID
	RecvID        string                   `protobuf:"bytes,2,opt,name=recvID,proto3" json:"recvID,omitempty"` // receiver ID
...
type ReportSpamReq struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	ReportedUserID string                 `protobuf:"bytes,1,opt,name=reportedUserID,proto3" json:"reportedUserID,omitempty"`
	ConversationID string                 `protobuf:"bytes,2,opt,name=conversationID,proto3" json:"conversationID,omitempty"`
	...
	ReasonType     int32                  `protobuf:"varint,5,opt,name=reasonType,proto3" json:"reasonType,omitempty"`
...
const file_msg_msg_proto_rawDesc = "" +
	...
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12+\n" +
	"\x05value\x18\x02 \x01(\v2\x15.openim.sdkws.MsgDataR\x05value:\x028\x01\"\xdb\x01\n" +
	"\rReportSpamReq\x12&\n" +
	...
	"\breportID\x18\x01 \x01(\tR\breportID2\xcd\x17\n" +
	"\x03msg\x12D\n" +
	...
	"\n" +
	"ReportSpam\x12\x19.openim.msg.ReportSpamReq\x1a\x1a.openim.msg.ReportSpamRespB#Z!github.com/openimsdk/protocol/msgb\x06proto3"
...
var file_msg_msg_proto_goTypes = []any{
	...
	(*ReportSpamReq)(nil),                        // 81: openim.msg.ReportSpamReq
	(*ReportSpamResp)(nil),                       // 82: openim.msg.ReportSpamResp
...
var file_msg_msg_proto_depIdxs = []int32{
	...
	81,  // 74: openim.msg.msg.ReportSpam:input_type -> openim.msg.ReportSpamReq
	...
	82,  // 108: openim.msg.msg.ReportSpam:output_type -> openim.msg.ReportSpamResp
