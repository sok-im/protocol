...
type RedPacketRecord struct {
	...
	Symbol                 string                 `protobuf:"bytes,31,opt,name=symbol,proto3" json:"symbol"`
...
func (x *RedPacketRecord) GetSymbol() string {
	if x != nil {
		return x.Symbol
	}
	return ""
...
const file_redpacket_redpacket_proto_rawDesc = "" +
	"\n" +
	"\x19redpacket/redpacket.proto\x12\x10openim.redpacket\"\xb3\b\n" +
	...
	"\bdecimals\x18\x19 \x01(\x05R\bdecimals\x12\x16\n" +
	"\x06symbol\x18\x1f \x01(\tR\x06symbol\x12.\n" +
