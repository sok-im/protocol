...
type GetUsersOnlineStatusResp_SuccessDetail struct {
	...
	LoginTime     int64                  `protobuf:"varint,5,opt,name=loginTime,proto3" json:"loginTime"`
	DeviceName    string                 `protobuf:"bytes,6,opt,name=deviceName,proto3" json:"deviceName"`
	DeviceModel   string                 `protobuf:"bytes,7,opt,name=deviceModel,proto3" json:"deviceModel"`
	SdkVersion    string                 `protobuf:"bytes,8,opt,name=sdkVersion,proto3" json:"sdkVersion"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *GetUsersOnlineStatusResp_SuccessDetail) GetLoginTime() int64 {
	if x != nil {
		return x.LoginTime
	}
	return 0
...
func (x *GetUsersOnlineStatusResp_SuccessDetail) GetDeviceName() string {
	if x != nil {
		return x.DeviceName
	}
	return ""
...
func (x *GetUsersOnlineStatusResp_SuccessDetail) GetDeviceModel() string {
	if x != nil {
...
func (x *GetUsersOnlineStatusResp_SuccessDetail) GetSdkVersion() string {
	if x != nil {
		return x.SdkVersion
	}
	return ""
...
const file_msggateway_msggateway_proto_rawDesc = "" +
	...
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\xb6\x05\n" +
	...
	"\ffailedResult\x18\x02 \x03(\v28.openim.msggateway.GetUsersOnlineStatusResp.FailedDetailR\ffailedResult\x1a\x81\x02\n" +
	...
	"\tloginTime\x18\x05 \x01(\x03R\tloginTime\x12\x1e\n" +
	"\n" +
	"deviceName\x18\x06 \x01(\tR\n" +
	"deviceName\x12 \n" +
	"\vdeviceModel\x18\a \x01(\tR\vdeviceModel\x12\x1e\n" +
	"\n" +
	"sdkVersion\x18\b \x01(\tR\n" +
	"sdkVersion\x1a&\n" +
