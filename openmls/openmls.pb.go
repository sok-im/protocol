...
type AddMemberTriggerReq struct {
	...
	NewMemberUserIDs []string               `protobuf:"bytes,3,rep,name=newMemberUserIDs,proto3" json:"newMemberUserIDs"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type RemoveMemberTriggerReq struct {
	...
	GroupID              string                 `protobuf:"bytes,1,opt,name=groupID,proto3" json:"groupID"`
	OperatorUserID       string                 `protobuf:"bytes,2,opt,name=operatorUserID,proto3" json:"operatorUserID"`
	RemovedMemberUserIDs []string               `protobuf:"bytes,3,rep,name=removedMemberUserIDs,proto3" json:"removedMemberUserIDs"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
