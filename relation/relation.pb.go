...
type FriendInfo struct {
	...
	IsMute         bool                   `protobuf:"varint,11,opt,name=isMute,proto3" json:"isMute"`
	MuteDuration   int64                  `protobuf:"varint,12,opt,name=muteDuration,proto3" json:"muteDuration"`
	MuteEndTime    int64                  `protobuf:"varint,13,opt,name=muteEndTime,proto3" json:"muteEndTime"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type UpdateFriendsReq struct {
	...
	IsMsgDestruct   *wrapperspb.BoolValue   `protobuf:"bytes,6,opt,name=isMsgDestruct,proto3" json:"isMsgDestruct"`
	MsgDestructTime *wrapperspb.Int64Value  `protobuf:"bytes,7,opt,name=msgDestructTime,proto3" json:"msgDestructTime"`
	BurnDuration    *wrapperspb.Int32Value  `protobuf:"bytes,8,opt,name=burnDuration,proto3" json:"burnDuration"`
	IsMute          *wrapperspb.BoolValue   `protobuf:"bytes,9,opt,name=isMute,proto3" json:"isMute"`
	MuteDuration    *wrapperspb.Int64Value  `protobuf:"bytes,10,opt,name=muteDuration,proto3" json:"muteDuration"`
	MuteEndTime     *wrapperspb.Int64Value  `protobuf:"bytes,11,opt,name=muteEndTime,proto3" json:"muteEndTime"`
	// owner 对好友设置的展示用名字，可选：absent 表示不修改，
	// 显式值（含 ""）表示更新。与 setFriendName 的 firstName/lastName 语义一致。
	FriendFirstName *wrapperspb.StringValue `protobuf:"bytes,12,opt,name=friendFirstName,proto3" json:"friendFirstName"`
	FriendLastName  *wrapperspb.StringValue `protobuf:"bytes,13,opt,name=friendLastName,proto3" json:"friendLastName"`
	// owner 对好友的私有备注，可选：absent 表示不修改，显式值（含 ""）表示更新。
	// note 独立于 remark，不参与好友显示（会话名、群成员昵称）。
	Note          *wrapperspb.StringValue `protobuf:"bytes,14,opt,name=note,proto3" json:"note"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateFriendsReq) GetIsMsgDestruct() *wrapperspb.BoolValue {
	if x != nil {
...
func (x *UpdateFriendsReq) GetMsgDestructTime() *wrapperspb.Int64Value {
	if x != nil {
...
func (x *UpdateFriendsReq) GetBurnDuration() *wrapperspb.Int32Value {
	if x != nil {
...
func (x *UpdateFriendsReq) GetIsMute() *wrapperspb.BoolValue {
	if x != nil {
		return x.IsMute
	}
	return nil
...
func (x *UpdateFriendsReq) GetMuteDuration() *wrapperspb.Int64Value {
	if x != nil {
		return x.MuteDuration
	}
	return nil
...
func (x *UpdateFriendsReq) GetMuteEndTime() *wrapperspb.Int64Value {
	if x != nil {
		return x.MuteEndTime
	}
	return nil
...
func (x *UpdateFriendsReq) GetFriendFirstName() *wrapperspb.StringValue {
	if x != nil {
...
func (x *UpdateFriendsReq) GetFriendLastName() *wrapperspb.StringValue {
	if x != nil {
...
func (x *UpdateFriendsReq) GetNote() *wrapperspb.StringValue {
	if x != nil {
		return x.Note
	}
	return nil
...
func (x *SetFriendNameReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetFriendNameReq) ProtoMessage() {}

func (x *SetFriendNameReq) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[37]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetFriendNameReq.ProtoReflect.Descriptor instead.
func (*SetFriendNameReq) Descriptor() ([]byte, []int) {
	return file_relation_relation_proto_rawDescGZIP(), []int{37}
}

func (x *SetFriendNameReq) GetOwnerUserID() string {
	if x != nil {
		return x.OwnerUserID
	}
	return ""
...
func (x *SetFriendNameReq) GetFriendUserID() string {
	if x != nil {
		return x.FriendUserID
	}
	return ""
...
type SetFriendNameResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetFriendNameResp) Reset() {
	*x = SetFriendNameResp{}
...
func (x *SetFriendNameResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetFriendNameResp) ProtoMessage() {}

func (x *SetFriendNameResp) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[38]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetFriendNameResp.ProtoReflect.Descriptor instead.
func (*SetFriendNameResp) Descriptor() ([]byte, []int) {
...
func (x *FriendInfoOnly) GetIsMsgDestruct() bool {
	if x != nil {
		return x.IsMsgDestruct
	}
	return false
...
func (x *FriendInfoOnly) GetMsgDestructTime() int64 {
	if x != nil {
		return x.MsgDestructTime
	}
	return 0
...
func (x *FriendInfoOnly) GetBurnDuration() int32 {
	if x != nil {
		return x.BurnDuration
	}
	return 0
...
func (x *FriendInfoOnly) GetIsMute() bool {
	if x != nil {
		return x.IsMute
	}
	return false
...
func (x *FriendInfoOnly) GetMuteDuration() int64 {
	if x != nil {
		return x.MuteDuration
	}
	return 0
...
func (x *FriendInfoOnly) GetMuteEndTime() int64 {
	if x != nil {
		return x.MuteEndTime
	}
	return 0
...
func (x *GetFriendPhoneReq) Reset() {
	*x = GetFriendPhoneReq{}
...
func (x *GetFriendPhoneReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFriendPhoneReq) ProtoMessage() {}

func (x *GetFriendPhoneReq) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[59]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFriendPhoneReq.ProtoReflect.Descriptor instead.
func (*GetFriendPhoneReq) Descriptor() ([]byte, []int) {
	return file_relation_relation_proto_rawDescGZIP(), []int{59}
}

func (x *GetFriendPhoneReq) GetOwnerUserID() string {
	if x != nil {
		return x.OwnerUserID
	}
	return ""
...
func (x *GetFriendPhoneReq) GetFriendUserID() string {
	if x != nil {
		return x.FriendUserID
	}
	return ""
...
type GetFriendPhoneResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Phone         string                 `protobuf:"bytes,1,opt,name=phone,json=Phone,proto3" json:"phone"`
	AreaCode      string                 `protobuf:"bytes,2,opt,name=areaCode,json=AreaCode,proto3" json:"areaCode"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *GetFriendPhoneResp) Reset() {
	*x = GetFriendPhoneResp{}
	mi := &file_relation_relation_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetFriendPhoneResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetFriendPhoneResp) ProtoMessage() {}

func (x *GetFriendPhoneResp) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[60]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetFriendPhoneResp.ProtoReflect.Descriptor instead.
func (*GetFriendPhoneResp) Descriptor() ([]byte, []int) {
	return file_relation_relation_proto_rawDescGZIP(), []int{60}
}

func (x *GetFriendPhoneResp) GetPhone() string {
	if x != nil {
		return x.Phone
	}
	return ""
...
func (x *GetFriendPhoneResp) GetAreaCode() string {
	if x != nil {
		return x.AreaCode
	}
	return ""
...
type GetPinnedFriendIDsReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserID        string                 `protobuf:"bytes,1,opt,name=userID,proto3" json:"userID"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetPinnedFriendIDsReq) Reset() {
	*x = GetPinnedFriendIDsReq{}
	mi := &file_relation_relation_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPinnedFriendIDsReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPinnedFriendIDsReq) ProtoMessage() {}

func (x *GetPinnedFriendIDsReq) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[61]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPinnedFriendIDsReq.ProtoReflect.Descriptor instead.
func (*GetPinnedFriendIDsReq) Descriptor() ([]byte, []int) {
	return file_relation_relation_proto_rawDescGZIP(), []int{61}
}

func (x *GetPinnedFriendIDsReq) GetUserID() string {
	if x != nil {
		return x.UserID
	}
	return ""
...
type GetPinnedFriendIDsResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetPinnedFriendIDsResp) Reset() {
	*x = GetPinnedFriendIDsResp{}
	mi := &file_relation_relation_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPinnedFriendIDsResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPinnedFriendIDsResp) ProtoMessage() {}

func (x *GetPinnedFriendIDsResp) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[62]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPinnedFriendIDsResp.ProtoReflect.Descriptor instead.
func (*GetPinnedFriendIDsResp) Descriptor() ([]byte, []int) {
	return file_relation_relation_proto_rawDescGZIP(), []int{62}
}

func (x *GetPinnedFriendIDsResp) GetFriendUserIDs() []string {
	if x != nil {
		return x.FriendUserIDs
	}
	return nil
...
// 好友备注（note）：owner 对好友的私有备注，独立于 remark。
// 与 remark 不同，note 不参与会话名、群成员昵称等好友显示；
// 通过 FriendInfo.note 随好友信息同步返回（getDesignatedFriends / 增量同步）。
type SetFriendNoteReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	OwnerUserID   string                 `protobuf:"bytes,1,opt,name=ownerUserID,proto3" json:"ownerUserID"`
	FriendUserID  string                 `protobuf:"bytes,2,opt,name=friendUserID,proto3" json:"friendUserID"`
...
func (x *SetFriendNoteReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetFriendNoteReq) ProtoMessage() {}

func (x *SetFriendNoteReq) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[63]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetFriendNoteReq.ProtoReflect.Descriptor instead.
func (*SetFriendNoteReq) Descriptor() ([]byte, []int) {
	return file_relation_relation_proto_rawDescGZIP(), []int{63}
}

func (x *SetFriendNoteReq) GetOwnerUserID() string {
	if x != nil {
		return x.OwnerUserID
	}
	return ""
...
func (x *SetFriendNoteReq) GetFriendUserID() string {
	if x != nil {
		return x.FriendUserID
	}
	return ""
...
func (x *SetFriendNoteReq) GetNote() string {
	if x != nil {
		return x.Note
	}
	return ""
...
type SetFriendNoteResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SetFriendNoteResp) Reset() {
	*x = SetFriendNoteResp{}
...
func (x *SetFriendNoteResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SetFriendNoteResp) ProtoMessage() {}

func (x *SetFriendNoteResp) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[64]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SetFriendNoteResp.ProtoReflect.Descriptor instead.
func (*SetFriendNoteResp) Descriptor() ([]byte, []int) {
...
// 好友会话置顶 / 取消置顶（同步更新 friend.is_pinned 与 conversation.isPinned）
...
func (x *PinFriendReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PinFriendReq) ProtoMessage() {}

func (x *PinFriendReq) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[69]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PinFriendReq.ProtoReflect.Descriptor instead.
func (*PinFriendReq) Descriptor() ([]byte, []int) {
	return file_relation_relation_proto_rawDescGZIP(), []int{69}
}

func (x *PinFriendReq) GetOwnerUserID() string {
	if x != nil {
		return x.OwnerUserID
	}
	return ""
...
func (x *PinFriendReq) GetFriendUserID() string {
	if x != nil {
		return x.FriendUserID
	}
	return ""
...
type PinFriendResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PinFriendResp) Reset() {
	*x = PinFriendResp{}
...
func (x *PinFriendResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PinFriendResp) ProtoMessage() {}

func (x *PinFriendResp) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[70]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PinFriendResp.ProtoReflect.Descriptor instead.
func (*PinFriendResp) Descriptor() ([]byte, []int) {
...
func (x *UnpinFriendReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnpinFriendReq) ProtoMessage() {}

func (x *UnpinFriendReq) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[71]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnpinFriendReq.ProtoReflect.Descriptor instead.
func (*UnpinFriendReq) Descriptor() ([]byte, []int) {
	return file_relation_relation_proto_rawDescGZIP(), []int{71}
}

func (x *UnpinFriendReq) GetOwnerUserID() string {
	if x != nil {
		return x.OwnerUserID
	}
	return ""
...
func (x *UnpinFriendReq) GetFriendUserID() string {
	if x != nil {
		return x.FriendUserID
	}
	return ""
...
type UnpinFriendResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UnpinFriendResp) Reset() {
	*x = UnpinFriendResp{}
...
func (x *UnpinFriendResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UnpinFriendResp) ProtoMessage() {}

func (x *UnpinFriendResp) ProtoReflect() protoreflect.Message {
	mi := &file_relation_relation_proto_msgTypes[72]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UnpinFriendResp.ProtoReflect.Descriptor instead.
func (*UnpinFriendResp) Descriptor() ([]byte, []int) {
...
const file_relation_relation_proto_rawDesc = "" +
	...
	"\bisPinned\x18\n" +
	" \x01(\bR\bisPinned\x12\x16\n" +
	"\x06isMute\x18\v \x01(\bR\x06isMute\x12\"\n" +
	"\fmuteDuration\x18\f \x01(\x03R\fmuteDuration\x12 \n" +
	"\vmuteEndTime\x18\r \x01(\x03R\vmuteEndTime\"Y\n" +
	...
	"\x16respondFriendApplyResp\"\xb4\x06\n" +
	...
	"\risMsgDestruct\x18\x06 \x01(\v2\x1a.openim.protobuf.BoolValueR\risMsgDestruct\x12E\n" +
	"\x0fmsgDestructTime\x18\a \x01(\v2\x1b.openim.protobuf.Int64ValueR\x0fmsgDestructTime\x12?\n" +
	"\fburnDuration\x18\b \x01(\v2\x1b.openim.protobuf.Int32ValueR\fburnDuration\x122\n" +
	"\x06isMute\x18\t \x01(\v2\x1a.openim.protobuf.BoolValueR\x06isMute\x12?\n" +
	"\fmuteDuration\x18\n" +
	" \x01(\v2\x1b.openim.protobuf.Int64ValueR\fmuteDuration\x12=\n" +
	"\vmuteEndTime\x18\v \x01(\v2\x1b.openim.protobuf.Int64ValueR\vmuteEndTime\x12F\n" +
	"\x0ffriendFirstName\x18\f \x01(\v2\x1c.openim.protobuf.StringValueR\x0ffriendFirstName\x12D\n" +
	"\x0efriendLastName\x18\r \x01(\v2\x1c.openim.protobuf.StringValueR\x0efriendLastName\x120\n" +
	"\x04note\x18\x0e \x01(\v2\x1c.openim.protobuf.StringValueR\x04note\"\x13\n" +
	...
	"\vfriendInfos\x18\x01 \x03(\v2\x1f.openim.relation.FriendInfoOnlyR\vfriendInfos\"Y\n" +
	"\x11getFriendPhoneReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12\"\n" +
	"\ffriendUserID\x18\x02 \x01(\tR\ffriendUserID\"F\n" +
	"\x12getFriendPhoneResp\x12\x14\n" +
	"\x05phone\x18\x01 \x01(\tR\x05Phone\x12\x1a\n" +
	"\bareaCode\x18\x02 \x01(\tR\bAreaCode\"/\n" +
	"\x15GetPinnedFriendIDsReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\">\n" +
	"\x16GetPinnedFriendIDsResp\x12$\n" +
	"\rfriendUserIDs\x18\x01 \x03(\tR\rfriendUserIDs\"l\n" +
	"\x10setFriendNoteReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12\"\n" +
	"\ffriendUserID\x18\x02 \x01(\tR\ffriendUserID\x12\x12\n" +
	"\x04note\x18\x03 \x01(\tR\x04note\"\x13\n" +
	"\x11setFriendNoteResp\"n\n" +
	"\n" +
	"setMuteReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12\"\n" +
	...
	"\fpinFriendReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12\"\n" +
	"\ffriendUserID\x18\x02 \x01(\tR\ffriendUserID\"\x0f\n" +
	"\rpinFriendResp\"V\n" +
	"\x0eunpinFriendReq\x12 \n" +
	"\vownerUserID\x18\x01 \x01(\tR\vownerUserID\x12\"\n" +
	"\ffriendUserID\x18\x02 \x01(\tR\ffriendUserID\"\x11\n" +
	"\x0funpinFriendResp2\xe2\x1c\n" +
	"\x06friend\x12_\n" +
	...
	"\fdeleteFriend\x12 .openim.relation.deleteFriendReq\x1a!.openim.relation.deleteFriendResp\x12Y\n" +
	"\x12deleteFriendOneway\x12 .openim.relation.deleteFriendReq\x1a!.openim.relation.deleteFriendResp\x12e\n" +
	...
	"\x0fsetFriendRemark\x12#.openim.relation.setFriendRemarkReq\x1a$.openim.relation.setFriendRemarkResp\x12V\n" +
	"\rsetFriendName\x12!.openim.relation.setFriendNameReq\x1a\".openim.relation.setFriendNameResp\x12T\n" +
	...
	"\rgetFriendInfo\x12!.openim.relation.getFriendInfoReq\x1a\".openim.relation.getFriendInfoResp\x12Y\n" +
	"\x0egetFriendPhone\x12\".openim.relation.getFriendPhoneReq\x1a#.openim.relation.getFriendPhoneResp\x12e\n" +
	...
	"\aGetMute\x12\x1b.openim.relation.getMuteReq\x1a\x1c.openim.relation.getMuteResp\x12J\n" +
	"\tpinFriend\x12\x1d.openim.relation.pinFriendReq\x1a\x1e.openim.relation.pinFriendResp\x12P\n" +
	"\vunpinFriend\x12\x1f.openim.relation.unpinFriendReq\x1a .openim.relation.unpinFriendResp\x12V\n" +
	"\rsetFriendNote\x12!.openim.relation.setFriendNoteReq\x1a\".openim.relation.setFriendNoteRespB(Z&github.com/openimsdk/protocol/relationb\x06proto3"
...
var file_relation_relation_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
var file_relation_relation_proto_goTypes = []any{
	...
	(*SetFriendNameReq)(nil),                   // 37: openim.relation.setFriendNameReq
	(*SetFriendNameResp)(nil),                  // 38: openim.relation.setFriendNameResp
	(*GetPaginationFriendsApplyFromReq)(nil),   // 39: openim.relation.getPaginationFriendsApplyFromReq
	(*GetPaginationFriendsApplyFromResp)(nil),  // 40: openim.relation.getPaginationFriendsApplyFromResp
	(*GetFriendIDsReq)(nil),                    // 41: openim.relation.getFriendIDsReq
	(*GetFriendIDsResp)(nil),                   // 42: openim.relation.getFriendIDsResp
	(*GetSpecifiedFriendsInfoReq)(nil),         // 43: openim.relation.getSpecifiedFriendsInfoReq
	(*GetSpecifiedFriendsInfoInfo)(nil),        // 44: openim.relation.getSpecifiedFriendsInfoInfo
	(*GetSpecifiedFriendsInfoResp)(nil),        // 45: openim.relation.getSpecifiedFriendsInfoResp
	(*GetIncrementalFriendsReq)(nil),           // 46: openim.relation.getIncrementalFriendsReq
	(*GetIncrementalFriendsResp)(nil),          // 47: openim.relation.getIncrementalFriendsResp
	(*GetIncrementalBlacksReq)(nil),            // 48: openim.relation.getIncrementalBlacksReq
	(*GetIncrementalBlacksResp)(nil),           // 49: openim.relation.getIncrementalBlacksResp
	(*GetSpecifiedBlacksReq)(nil),              // 50: openim.relation.GetSpecifiedBlacksReq
	(*GetSpecifiedBlacksResp)(nil),             // 51: openim.relation.GetSpecifiedBlacksResp
	(*GetFullFriendUserIDsReq)(nil),            // 52: openim.relation.getFullFriendUserIDsReq
	(*GetFullFriendUserIDsResp)(nil),           // 53: openim.relation.getFullFriendUserIDsResp
	(*NotificationUserInfoUpdateReq)(nil),      // 54: openim.relation.notificationUserInfoUpdateReq
	(*NotificationUserInfoUpdateResp)(nil),     // 55: openim.relation.notificationUserInfoUpdateResp
	(*FriendInfoOnly)(nil),                     // 56: openim.relation.FriendInfoOnly
	(*GetFriendInfoReq)(nil),                   // 57: openim.relation.getFriendInfoReq
	(*GetFriendInfoResp)(nil),                  // 58: openim.relation.getFriendInfoResp
	(*GetFriendPhoneReq)(nil),                  // 59: openim.relation.getFriendPhoneReq
	(*GetFriendPhoneResp)(nil),                 // 60: openim.relation.getFriendPhoneResp
	(*GetPinnedFriendIDsReq)(nil),              // 61: openim.relation.GetPinnedFriendIDsReq
	(*GetPinnedFriendIDsResp)(nil),             // 62: openim.relation.GetPinnedFriendIDsResp
	(*SetFriendNoteReq)(nil),                   // 63: openim.relation.setFriendNoteReq
	(*SetFriendNoteResp)(nil),                  // 64: openim.relation.setFriendNoteResp
	(*SetMuteReq)(nil),                         // 65: openim.relation.setMuteReq
	(*SetMuteResp)(nil),                        // 66: openim.relation.setMuteResp
	(*GetMuteReq)(nil),                         // 67: openim.relation.getMuteReq
	(*GetMuteResp)(nil),                        // 68: openim.relation.getMuteResp
	(*PinFriendReq)(nil),                       // 69: openim.relation.pinFriendReq
	(*PinFriendResp)(nil),                      // 70: openim.relation.pinFriendResp
	(*UnpinFriendReq)(nil),                     // 71: openim.relation.unpinFriendReq
	(*UnpinFriendResp)(nil),                    // 72: openim.relation.unpinFriendResp
	(*sdkws.RequestPagination)(nil),            // 73: openim.sdkws.RequestPagination
	(*sdkws.FriendInfo)(nil),                   // 74: openim.sdkws.FriendInfo
	(*sdkws.FriendRequest)(nil),                // 75: openim.sdkws.FriendRequest
	(*sdkws.BlackInfo)(nil),                    // 76: openim.sdkws.BlackInfo
	...
	(*wrapperspb.Int32Value)(nil),              // 80: openim.protobuf.Int32Value
	(*sdkws.UserInfo)(nil),                     // 81: openim.sdkws.UserInfo
}
var file_relation_relation_proto_depIdxs = []int32{
	73, // 0: openim.relation.getPaginationFriendsReq.pagination:type_name -> openim.sdkws.RequestPagination
	74, // 1: openim.relation.getPaginationFriendsResp.friendsInfo:type_name -> openim.sdkws.FriendInfo
	73, // 2: openim.relation.getPaginationFriendsApplyToReq.pagination:type_name -> openim.sdkws.RequestPagination
	75, // 3: openim.relation.getPaginationFriendsApplyToResp.FriendRequests:type_name -> openim.sdkws.FriendRequest
	75, // 4: openim.relation.getDesignatedFriendsApplyResp.friendRequests:type_name -> openim.sdkws.FriendRequest
	75, // 5: openim.relation.getIncrementalFriendsApplyToResp.changes:type_name -> openim.sdkws.FriendRequest
	75, // 6: openim.relation.getIncrementalFriendsApplyFromResp.changes:type_name -> openim.sdkws.FriendRequest
	74, // 7: openim.relation.getDesignatedFriendsResp.friendsInfo:type_name -> openim.sdkws.FriendInfo
	73, // 8: openim.relation.getPaginationBlacksReq.pagination:type_name -> openim.sdkws.RequestPagination
	76, // 9: openim.relation.getPaginationBlacksResp.blacks:type_name -> openim.sdkws.BlackInfo
	77, // 10: openim.relation.updateFriendsReq.isPinned:type_name -> openim.protobuf.BoolValue
	78, // 11: openim.relation.updateFriendsReq.remark:type_name -> openim.protobuf.StringValue
	78, // 12: openim.relation.updateFriendsReq.ex:type_name -> openim.protobuf.StringValue
	77, // 13: openim.relation.updateFriendsReq.isMsgDestruct:type_name -> openim.protobuf.BoolValue
	79, // 14: openim.relation.updateFriendsReq.msgDestructTime:type_name -> openim.protobuf.Int64Value
	80, // 15: openim.relation.updateFriendsReq.burnDuration:type_name -> openim.protobuf.Int32Value
	77, // 16: openim.relation.updateFriendsReq.isMute:type_name -> openim.protobuf.BoolValue
	79, // 17: openim.relation.updateFriendsReq.muteDuration:type_name -> openim.protobuf.Int64Value
	79, // 18: openim.relation.updateFriendsReq.muteEndTime:type_name -> openim.protobuf.Int64Value
	78, // 19: openim.relation.updateFriendsReq.friendFirstName:type_name -> openim.protobuf.StringValue
	78, // 20: openim.relation.updateFriendsReq.friendLastName:type_name -> openim.protobuf.StringValue
	78, // 21: openim.relation.updateFriendsReq.note:type_name -> openim.protobuf.StringValue
	73, // 22: openim.relation.getPaginationFriendsApplyFromReq.pagination:type_name -> openim.sdkws.RequestPagination
	75, // 23: openim.relation.getPaginationFriendsApplyFromResp.friendRequests:type_name -> openim.sdkws.FriendRequest
	81, // 24: openim.relation.getSpecifiedFriendsInfoInfo.userInfo:type_name -> openim.sdkws.UserInfo
	74, // 25: openim.relation.getSpecifiedFriendsInfoInfo.friendInfo:type_name -> openim.sdkws.FriendInfo
	76, // 26: openim.relation.getSpecifiedFriendsInfoInfo.blackInfo:type_name -> openim.sdkws.BlackInfo
	44, // 27: openim.relation.getSpecifiedFriendsInfoResp.infos:type_name -> openim.relation.getSpecifiedFriendsInfoInfo
	74, // 28: openim.relation.getIncrementalFriendsResp.insert:type_name -> openim.sdkws.FriendInfo
	74, // 29: openim.relation.getIncrementalFriendsResp.update:type_name -> openim.sdkws.FriendInfo
	76, // 30: openim.relation.getIncrementalBlacksResp.insert:type_name -> openim.sdkws.BlackInfo
	76, // 31: openim.relation.getIncrementalBlacksResp.update:type_name -> openim.sdkws.BlackInfo
	76, // 32: openim.relation.GetSpecifiedBlacksResp.blacks:type_name -> openim.sdkws.BlackInfo
	81, // 33: openim.relation.notificationUserInfoUpdateReq.oldUserInfo:type_name -> openim.sdkws.UserInfo
	81, // 34: openim.relation.notificationUserInfoUpdateReq.newUserInfo:type_name -> openim.sdkws.UserInfo
	56, // 35: openim.relation.getFriendInfoResp.friendInfos:type_name -> openim.relation.FriendInfoOnly
	2,  // 36: openim.relation.friend.applyToAddFriend:input_type -> openim.relation.applyToAddFriendReq
	2,  // 37: openim.relation.friend.addOnewayFriend:input_type -> openim.relation.applyToAddFriendReq
	7,  // 38: openim.relation.friend.getPaginationFriendsApplyTo:input_type -> openim.relation.getPaginationFriendsApplyToReq
	39, // 39: openim.relation.friend.getPaginationFriendsApplyFrom:input_type -> openim.relation.getPaginationFriendsApplyFromReq
	11, // 40: openim.relation.friend.getSelfUnhandledApplyCount:input_type -> openim.relation.getSelfUnhandledApplyCountReq
	9,  // 41: openim.relation.friend.getDesignatedFriendsApply:input_type -> openim.relation.getDesignatedFriendsApplyReq
	13, // 42: openim.relation.friend.getIncrementalFriendsApplyTo:input_type -> openim.relation.getIncrementalFriendsApplyToReq
	15, // 43: openim.relation.friend.getIncrementalFriendsApplyFrom:input_type -> openim.relation.getIncrementalFriendsApplyFromReq
	19, // 44: openim.relation.friend.addBlack:input_type -> openim.relation.addBlackReq
	21, // 45: openim.relation.friend.removeBlack:input_type -> openim.relation.removeBlackReq
	25, // 46: openim.relation.friend.isFriend:input_type -> openim.relation.isFriendReq
	27, // 47: openim.relation.friend.isBlack:input_type -> openim.relation.isBlackReq
	23, // 48: openim.relation.friend.getPaginationBlacks:input_type -> openim.relation.getPaginationBlacksReq
	50, // 49: openim.relation.friend.GetSpecifiedBlacks:input_type -> openim.relation.GetSpecifiedBlacksReq
	29, // 50: openim.relation.friend.deleteFriend:input_type -> openim.relation.deleteFriendReq
	29, // 51: openim.relation.friend.deleteFriendOneway:input_type -> openim.relation.deleteFriendReq
	31, // 52: openim.relation.friend.respondFriendApply:input_type -> openim.relation.respondFriendApplyReq
	33, // 53: openim.relation.friend.updateFriends:input_type -> openim.relation.updateFriendsReq
	35, // 54: openim.relation.friend.setFriendRemark:input_type -> openim.relation.setFriendRemarkReq
	37, // 55: openim.relation.friend.setFriendName:input_type -> openim.relation.setFriendNameReq
	5,  // 56: openim.relation.friend.importFriends:input_type -> openim.relation.importFriendReq
	17, // 57: openim.relation.friend.getDesignatedFriends:input_type -> openim.relation.getDesignatedFriendsReq
	0,  // 58: openim.relation.friend.getPaginationFriends:input_type -> openim.relation.getPaginationFriendsReq
	41, // 59: openim.relation.friend.getFriendIDs:input_type -> openim.relation.getFriendIDsReq
	43, // 60: openim.relation.friend.GetSpecifiedFriendsInfo:input_type -> openim.relation.getSpecifiedFriendsInfoReq
	46, // 61: openim.relation.friend.getIncrementalFriends:input_type -> openim.relation.getIncrementalFriendsReq
	48, // 62: openim.relation.friend.getIncrementalBlacks:input_type -> openim.relation.getIncrementalBlacksReq
	52, // 63: openim.relation.friend.getFullFriendUserIDs:input_type -> openim.relation.getFullFriendUserIDsReq
	54, // 64: openim.relation.friend.NotificationUserInfoUpdate:input_type -> openim.relation.notificationUserInfoUpdateReq
	57, // 65: openim.relation.friend.getFriendInfo:input_type -> openim.relation.getFriendInfoReq
	59, // 66: openim.relation.friend.getFriendPhone:input_type -> openim.relation.getFriendPhoneReq
	61, // 67: openim.relation.friend.GetPinnedFriendIDs:input_type -> openim.relation.GetPinnedFriendIDsReq
	65, // 68: openim.relation.friend.SetMute:input_type -> openim.relation.setMuteReq
	67, // 69: openim.relation.friend.GetMute:input_type -> openim.relation.getMuteReq
	69, // 70: openim.relation.friend.pinFriend:input_type -> openim.relation.pinFriendReq
	71, // 71: openim.relation.friend.unpinFriend:input_type -> openim.relation.unpinFriendReq
	63, // 72: openim.relation.friend.setFriendNote:input_type -> openim.relation.setFriendNoteReq
	3,  // 73: openim.relation.friend.applyToAddFriend:output_type -> openim.relation.applyToAddFriendResp
	3,  // 74: openim.relation.friend.addOnewayFriend:output_type -> openim.relation.applyToAddFriendResp
	8,  // 75: openim.relation.friend.getPaginationFriendsApplyTo:output_type -> openim.relation.getPaginationFriendsApplyToResp
	40, // 76: openim.relation.friend.getPaginationFriendsApplyFrom:output_type -> openim.relation.getPaginationFriendsApplyFromResp
	12, // 77: openim.relation.friend.getSelfUnhandledApplyCount:output_type -> openim.relation.getSelfUnhandledApplyCountResp
	10, // 78: openim.relation.friend.getDesignatedFriendsApply:output_type -> openim.relation.getDesignatedFriendsApplyResp
	14, // 79: openim.relation.friend.getIncrementalFriendsApplyTo:output_type -> openim.relation.getIncrementalFriendsApplyToResp
	16, // 80: openim.relation.friend.getIncrementalFriendsApplyFrom:output_type -> openim.relation.getIncrementalFriendsApplyFromResp
	20, // 81: openim.relation.friend.addBlack:output_type -> openim.relation.addBlackResp
	22, // 82: openim.relation.friend.removeBlack:output_type -> openim.relation.removeBlackResp
	26, // 83: openim.relation.friend.isFriend:output_type -> openim.relation.isFriendResp
	28, // 84: openim.relation.friend.isBlack:output_type -> openim.relation.isBlackResp
	24, // 85: openim.relation.friend.getPaginationBlacks:output_type -> openim.relation.getPaginationBlacksResp
	51, // 86: openim.relation.friend.GetSpecifiedBlacks:output_type -> openim.relation.GetSpecifiedBlacksResp
	30, // 87: openim.relation.friend.deleteFriend:output_type -> openim.relation.deleteFriendResp
	30, // 88: openim.relation.friend.deleteFriendOneway:output_type -> openim.relation.deleteFriendResp
	32, // 89: openim.relation.friend.respondFriendApply:output_type -> openim.relation.respondFriendApplyResp
	34, // 90: openim.relation.friend.updateFriends:output_type -> openim.relation.updateFriendsResp
	36, // 91: openim.relation.friend.setFriendRemark:output_type -> openim.relation.setFriendRemarkResp
	38, // 92: openim.relation.friend.setFriendName:output_type -> openim.relation.setFriendNameResp
	6,  // 93: openim.relation.friend.importFriends:output_type -> openim.relation.importFriendResp
	18, // 94: openim.relation.friend.getDesignatedFriends:output_type -> openim.relation.getDesignatedFriendsResp
	1,  // 95: openim.relation.friend.getPaginationFriends:output_type -> openim.relation.getPaginationFriendsResp
	42, // 96: openim.relation.friend.getFriendIDs:output_type -> openim.relation.getFriendIDsResp
	45, // 97: openim.relation.friend.GetSpecifiedFriendsInfo:output_type -> openim.relation.getSpecifiedFriendsInfoResp
	47, // 98: openim.relation.friend.getIncrementalFriends:output_type -> openim.relation.getIncrementalFriendsResp
	49, // 99: openim.relation.friend.getIncrementalBlacks:output_type -> openim.relation.getIncrementalBlacksResp
	53, // 100: openim.relation.friend.getFullFriendUserIDs:output_type -> openim.relation.getFullFriendUserIDsResp
	55, // 101: openim.relation.friend.NotificationUserInfoUpdate:output_type -> openim.relation.notificationUserInfoUpdateResp
	58, // 102: openim.relation.friend.getFriendInfo:output_type -> openim.relation.getFriendInfoResp
	60, // 103: openim.relation.friend.getFriendPhone:output_type -> openim.relation.getFriendPhoneResp
	62, // 104: openim.relation.friend.GetPinnedFriendIDs:output_type -> openim.relation.GetPinnedFriendIDsResp
	66, // 105: openim.relation.friend.SetMute:output_type -> openim.relation.setMuteResp
	68, // 106: openim.relation.friend.GetMute:output_type -> openim.relation.getMuteResp
	70, // 107: openim.relation.friend.pinFriend:output_type -> openim.relation.pinFriendResp
	72, // 108: openim.relation.friend.unpinFriend:output_type -> openim.relation.unpinFriendResp
	64, // 109: openim.relation.friend.setFriendNote:output_type -> openim.relation.setFriendNoteResp
