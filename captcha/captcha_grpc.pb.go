...
func (c *captchaClient) GenerateCaptcha(ctx context.Context, in *GenerateCaptchaReq, opts ...grpc.CallOption) (*GenerateCaptchaResp, error) {
...
func (UnimplementedCaptchaServer) GenerateCaptcha(context.Context, *GenerateCaptchaReq) (*GenerateCaptchaResp, error) {
...
func RegisterCaptchaServer(s grpc.ServiceRegistrar, srv CaptchaServer) {
	// If the following call panics, it indicates UnimplementedCaptchaServer was
...
func _Captcha_GenerateCaptcha_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CaptchaServer).GenerateCaptcha(ctx, req.(*GenerateCaptchaReq))
	}
...
var Captcha_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "openim.captcha.Captcha",
	...
	Metadata: "protocol/captcha/captcha.proto",
}
